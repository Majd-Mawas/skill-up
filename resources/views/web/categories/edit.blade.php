@extends('layouts.vertical', ['title' => 'Categories', 'sub_title' => 'Edit', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
                    ...
                    <div class="p-6">
                        <div class="grid gap-6">
                            ...
                            <div>
                                ...
                                <textarea rows="4" class="form-textarea" name="description" placeholder="Enter category description">{{ old('description', $category->description) }}</textarea>
                                @error('description')
                                    <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                                @enderror
                            </div>
