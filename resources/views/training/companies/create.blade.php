@extends('layouts.vertical', ['title' => 'Companies', 'sub_title' => 'Create', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
                        ...
                        <div class="grid lg:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label for="contact_email"
                                    class="text-gray-800 text-sm font-medium inline-block mb-2">Contact Email</label>
