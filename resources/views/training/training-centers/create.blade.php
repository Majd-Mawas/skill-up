@extends('layouts.vertical', ['title' => 'Training Centers', 'sub_title' => 'Create', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
                ...
                <div class="card">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-6">
                            ...
                            <textarea rows="4" class="form-textarea ltr:rounded-s-none rtl:rounded-e-none" name="address">{{ old('address') }}</textarea>
                            @error('address')
                                <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
